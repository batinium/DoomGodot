...
@onready var firecrystal =preload("res://Player/Weapons/firecrystal/fire_crystal.tscn")
...
func launch_projectile():
	var new_firecrystal = firecrystal.instantiate()
	get_node("/root/World").add_child(new_firecrystal)
	new_firecrystal.global_transform = spawn_location.global_transform
	$Marker3D/shoot.play()
